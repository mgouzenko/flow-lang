OBJS = parser.cmo scanner.cmo printer.cmo compile.cmo semantic_analysis.cmo flowc.cmo
...
ast.cmo:
ast.cmx:
flowc.cmo: scanner.cmo printer.cmo parser.cmi ast.cmo compile.cmo semantic_analysis.cmo
flowc.cmx: scanner.cmx printer.cmx parser.cmx ast.cmx compile.cmx semantic_analysis.cmx
