...
type s_dot_initializer = {
    s_dot_initializer_id: string;
    s_dot_initializer_val: typed_expr;
}
...
and typed_expr = expr_details * flow_type

type s_variable_declaration = {
    s_declaration_type: flow_type;
    s_declaration_id: string;
...
type s_function_declaration = {
    ...
    s_function_name: string;
    s_arguments: s_variable_declaration list;
    s_has_definition: bool;
    s_body : s_stmt list;
}
